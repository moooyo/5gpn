...
|---|---|---|---|---|
| 5gpn mihomo fork | [`moooyo/mihomo` `v1.19.28-monolith.20`](https://github.com/moooyo/mihomo/releases/tag/v1.19.28-monolith.20), `mihomo-linux-amd64-compatible-v1.19.28-monolith.20.gz` | `3915ea46667f1947e8964ae4a6a17c5ad45184df0b31a480e8be7b772d70a9f7` | GPL-3.0; see the exact tag's [`LICENSE`](https://github.com/moooyo/mihomo/blob/v1.19.28-monolith.20/LICENSE) and [source](https://github.com/moooyo/mihomo/tree/v1.19.28-monolith.20) | Installed as `/opt/5gpn/bin/5gpn-mihomo`; this is the sole long-running 5gpn process. |
